...
namespace WordConnect
{
    public class GameController : SingletonComponent<GameController>, ISaveable
    {
        ...
        [SerializeField] private int openedWordsInARowToPopup = 3;
        private int openedWordsInARow = 0;
        ...
        private void ShowWordOnBoard(ActiveLevel level, WordData levelWordData)
        {
            ...
            openedWordsInARow++;
            if (openedWordsInARow >= openedWordsInARowToPopup)
            {
                openedWordsInARow = 0;
                PopupManager.Instance.Show("in_a_row");
            }

        }

        public void ResetInARowVariable()
        {
            openedWordsInARow = 0;
        }
